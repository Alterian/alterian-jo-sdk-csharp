...
namespace Alterian.JO.Test.Api
{
    ...
    public class ClusterApiTests : IDisposable
    {
        ...
        public void ClusterDecommissionDeleteTest()
        {
            ...
            //var response = instance.ClusterDecommissionDelete(targetnode);
            //Assert.IsType<ClusterResponse>(response);
        }
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.ClusterDelete();
            //Assert.IsType<ClusterResponse>(response);
        }
        ...
        public void ClusterPostTest()
        {
            ...
            //var response = instance.ClusterPost(cluster);
            //Assert.IsType<ClusterResponse>(response);
        }
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //ClusterSetting? clusterSetting = null;
            //var response = instance.ClusterPut(clusterSetting);
            //Assert.IsType<ApiResponse>(response);
        }
        ...
        public void ClusterStreamGetTest()
        {
            ...
            //Assert.IsType<ClusterStreamResponse>(response);
        }
        ...
        public void ClusterStreamThroughputGetTest()
        {
            ...
            //Assert.IsType<ClusterThroughputResponse>(response);
        }
