...
namespace Alterian.JO.Test.Api
{
    ...
    public class QueueApiTests : IDisposable
    {
        ...
        public void QueueClientTargetQueueNamePostTest()
        {
            ...
            //string queueName = null;
            //string body = null;
            //var response = instance.QueueClientTargetQueueNamePost(varClient, target, queueName, body);
            //Assert.IsType<ApiResponse>(response);
        }
        ...
        public void QueueClientTargetQueueNamePutTest()
        {
            ...
            //string queueName = null;
            //string body = null;
            //var response = instance.QueueClientTargetQueueNamePut(varClient, target, queueName, body);
            //Assert.IsType<ApiResponse>(response);
        }
