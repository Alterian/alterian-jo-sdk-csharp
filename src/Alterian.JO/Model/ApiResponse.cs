...
namespace Alterian.JO.Model
{
    ...
    public partial class ApiResponse : IValidatableObject
    {
        ...
        public ApiResponse(SuccessCursor cursor = default(SuccessCursor), string debug = default(string), string exceptionType = default(string), string message = default(string), string status = default(string))
        {
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for ApiResponse and cannot be null");
            }
            this.Status = status;
            this.Cursor = cursor;
            this.Debug = debug;
