...
namespace Alterian.JO.Model
{
    ...
    public partial class RoleList : IValidatableObject
    {
        /// <summary>
        ...
        public RoleList(SuccessCursor cursor = default(SuccessCursor), string debug = default(string), string exceptionType = default(string), string message = default(string), string status = default(string), List<Role> data = default(List<Role>))
        {
            this.Cursor = cursor;
            this.Debug = debug;
