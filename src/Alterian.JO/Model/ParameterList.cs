...
namespace Alterian.JO.Model
{
    ...
    /// ParameterList
    /// </summary>
    [DataContract(Name = "parameterList")]
    public partial class ParameterList : IValidatableObject
    {
        /// <summary>
        ...
        public ParameterList(SuccessCursor cursor = default(SuccessCursor), string debug = default(string), string exceptionType = default(string), string message = default(string), string status = default(string), List<Parameter> data = default(List<Parameter>))
        {
            this.Cursor = cursor;
            this.Debug = debug;
