...
namespace Alterian.JO.Model
{
    ...
    public partial class UserList : IValidatableObject
    {
        ...
        public UserList(SuccessCursor cursor = default(SuccessCursor), string debug = default(string), string exceptionType = default(string), string message = default(string), string status = default(string), List<User> data = default(List<User>))
        {
            this.Cursor = cursor;
            this.Debug = debug;
