...
namespace Alterian.JO.Model
{
    ...
    public partial class RuleGroup : IValidatableObject
    {
        ...
        public RuleGroup(string description = default(string), bool enableInvoke = default(bool), string name = default(string), List<string> referencedRules = default(List<string>))
        {
