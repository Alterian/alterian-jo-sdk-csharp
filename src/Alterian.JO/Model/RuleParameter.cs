...
namespace Alterian.JO.Model
{
    ...
    /// RuleParameter
    /// </summary>
    [DataContract(Name = "ruleParameter")]
    public partial class RuleParameter : IValidatableObject
    {
        /// <summary>
        /// The data type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RuleParameter" /> class.
        /// </summary>
        ...
        public RuleParameter(string businessGoal = default(string), string varClient = default(string), DataTypeEnum? dataType = default(DataTypeEnum?), string description = default(string), bool globalParam = default(bool), bool isConfidential = default(bool), bool isEditable = default(bool), bool isForcedValue = default(bool), bool isVisible = default(bool), string name = default(string), List<PickListItem> picklistItems = default(List<PickListItem>), bool requiresAdmin = default(bool), List<TargetValue> targets = default(List<TargetValue>), string units = default(string), string url = default(string), string defaultValue = default(string), string parameterName = default(string), bool usingGlobal = default(bool))
        {
        ...
        /// </summary>
        [DataMember(Name = "usingGlobal", EmitDefaultValue = true)]
