...
namespace Alterian.JO.Model
{
    ...
    /// ClusterDetails
    /// </summary>
    [DataContract(Name = "ClusterDetails")]
    public partial class ClusterDetails : IValidatableObject
    {
        /// <summary>
        ...
        public ClusterDetails(string nodeName = default(string), string publicIp = default(string), DateTime lastSeen = default(DateTime), int restartCount = default(int), string host = default(string), string state = default(string), string firstDownTime = default(string), string nodeDescription = default(string), string reportedBy = default(string), string varVersion = default(string), string consistency = default(string), int bootstrapVersion = default(int), List<ServerSettings> serverSettings = default(List<ServerSettings>))
        {
