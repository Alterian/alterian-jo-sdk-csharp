...
namespace Alterian.JO.Model
{
    ...
    public partial class Role : IValidatableObject
    {
        ...
        public Role(string lastModifiedDate = default(string), string lastModifiedUser = default(string), string name = default(string), bool varSystem = default(bool), List<string> permissions = default(List<string>))
        {
