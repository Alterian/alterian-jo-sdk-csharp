...
namespace Alterian.JO.Model
{
    ...
    /// ClusterPutRequest
    /// </summary>
    [DataContract(Name = "_cluster_put_request")]
    public partial class ClusterPutRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClusterPutRequest" /> class.
        /// </summary>
        ...
        public ClusterPutRequest(string attributeName = default(string), string attributeValue = default(string), string collectionName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClusterPutRequest {\n");
