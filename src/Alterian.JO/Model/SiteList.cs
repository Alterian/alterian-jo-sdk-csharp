...
namespace Alterian.JO.Model
{
    ...
    public partial class SiteList : IValidatableObject
    {
        ...
        public SiteList(SuccessCursor cursor = default(SuccessCursor), string debug = default(string), string exceptionType = default(string), string message = default(string), string status = default(string), List<Site> data = default(List<Site>))
        {
            this.Cursor = cursor;
            this.Debug = debug;
