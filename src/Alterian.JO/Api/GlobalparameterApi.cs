...
namespace Alterian.JO.Api
{
    ...
    public interface IGlobalparameterApiSync : IApiAccessor
    {
        ...
        System.IO.Stream DownloadGlobalparameterClientParamnameGet(string varClient, string paramname, int operationIndex = 0);
        ...
        ApiResponse<System.IO.Stream> DownloadGlobalparameterClientParamnameGetWithHttpInfo(string varClient, string paramname, int operationIndex = 0);
        /// <summary>
    ...
    public interface IGlobalparameterApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<System.IO.Stream> DownloadGlobalparameterClientParamnameGetAsync(string varClient, string paramname, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> DownloadGlobalparameterClientParamnameGetWithHttpInfoAsync(string varClient, string paramname, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get target parameter for for specific client
        /// </summary>
        /// <remarks>
    ...
    public partial class GlobalparameterApi : IGlobalparameterApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>System.IO.Stream</returns>
        public System.IO.Stream DownloadGlobalparameterClientParamnameGet(string varClient, string paramname, int operationIndex = 0)
        {
            Alterian.JO.Client.ApiResponse<System.IO.Stream> localVarResponse = DownloadGlobalparameterClientParamnameGetWithHttpInfo(varClient, paramname);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public Alterian.JO.Client.ApiResponse<System.IO.Stream> DownloadGlobalparameterClientParamnameGetWithHttpInfo(string varClient, string paramname, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Get<System.IO.Stream>("/download/globalparameter/{client}/{paramname}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of System.IO.Stream</returns>
        public async System.Threading.Tasks.Task<System.IO.Stream> DownloadGlobalparameterClientParamnameGetAsync(string varClient, string paramname, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Alterian.JO.Client.ApiResponse<System.IO.Stream> localVarResponse = await DownloadGlobalparameterClientParamnameGetWithHttpInfoAsync(varClient, paramname, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        public async System.Threading.Tasks.Task<Alterian.JO.Client.ApiResponse<System.IO.Stream>> DownloadGlobalparameterClientParamnameGetWithHttpInfoAsync(string varClient, string paramname, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'varClient' is set
            if (varClient == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<System.IO.Stream>("/download/globalparameter/{client}/{paramname}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
