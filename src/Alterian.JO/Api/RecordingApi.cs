...
namespace Alterian.JO.Api
{
    ...
    public interface IRecordingApiSync : IApiAccessor
    {
        ...
        /// <param name="target">Which target should we filter to?</param>
        /// <param name="name">The name of the recording</param>
        /// <param name="since">Optional &#39;since&#39; values for paging large data - pass in the value from the last row returned. Use instead of &#39;From&#39; (optional)</param>
        /// <param name="from">The zero-based index of the first item to return. (optional)</param>
        /// <param name="to">The zero-based index of the last item to return. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        void RecordingClientTargetNameEventsGet(string varClient, TargetEnum target, string name, string? since = default(string?), int? from = default(int?), int? to = default(int?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> RecordingClientTargetNameEventsGetWithHttpInfo(string varClient, TargetEnum target, string name, string? since = default(string?), int? from = default(int?), int? to = default(int?), int operationIndex = 0);
        /// <summary>
    ...
    public interface IRecordingApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task RecordingClientTargetNameEventsGetAsync(string varClient, TargetEnum target, string name, string? since = default(string?), int? from = default(int?), int? to = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> RecordingClientTargetNameEventsGetWithHttpInfoAsync(string varClient, TargetEnum target, string name, string? since = default(string?), int? from = default(int?), int? to = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get details about a specific recording
        /// </summary>
        /// <remarks>
    ...
    public partial class RecordingApi : IRecordingApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void RecordingClientTargetNameEventsGet(string varClient, TargetEnum target, string name, string? since = default(string?), int? from = default(int?), int? to = default(int?), int operationIndex = 0)
        {
            RecordingClientTargetNameEventsGetWithHttpInfo(varClient, target, name, since, from, to);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Alterian.JO.Client.ApiResponse<Object> RecordingClientTargetNameEventsGetWithHttpInfo(string varClient, TargetEnum target, string name, string? since = default(string?), int? from = default(int?), int? to = default(int?), int operationIndex = 0)
        {
            // verify the required parameter 'varClient' is set
            if (varClient == null)
            {
            ...
            if (since != null)
            {
                localVarRequestOptions.QueryParameters.Add(Alterian.JO.Client.ClientUtils.ParameterToMultiMap("", "since", since));
            }
            if (from != null)
            {
                localVarRequestOptions.QueryParameters.Add(Alterian.JO.Client.ClientUtils.ParameterToMultiMap("", "from", from));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task RecordingClientTargetNameEventsGetAsync(string varClient, TargetEnum target, string name, string? since = default(string?), int? from = default(int?), int? to = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await RecordingClientTargetNameEventsGetWithHttpInfoAsync(varClient, target, name, since, from, to, operationIndex, cancellationToken).ConfigureAwait(false);
        }
