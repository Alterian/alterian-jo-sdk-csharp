...
namespace Alterian.JO.Api
{
    ...
    public interface IRulesApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void DownloadRuleTargetClientRulenameGet(TargetEnum target, string varClient, string rulename, int operationIndex = 0);
        ...
        ApiResponse<Object> DownloadRuleTargetClientRulenameGetWithHttpInfo(TargetEnum target, string varClient, string rulename, int operationIndex = 0);
        /// <summary>
    ...
    public interface IRulesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task DownloadRuleTargetClientRulenameGetAsync(TargetEnum target, string varClient, string rulename, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DownloadRuleTargetClientRulenameGetWithHttpInfoAsync(TargetEnum target, string varClient, string rulename, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get information about all published rules on the server
        /// </summary>
        /// <remarks>
    ...
    public partial class RulesApi : IRulesApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DownloadRuleTargetClientRulenameGet(TargetEnum target, string varClient, string rulename, int operationIndex = 0)
        {
            DownloadRuleTargetClientRulenameGetWithHttpInfo(target, varClient, rulename);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Alterian.JO.Client.ApiResponse<Object> DownloadRuleTargetClientRulenameGetWithHttpInfo(TargetEnum target, string varClient, string rulename, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Get<Object>("/download/rule/{target}/{client}/{rulename}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DownloadRuleTargetClientRulenameGetAsync(TargetEnum target, string varClient, string rulename, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DownloadRuleTargetClientRulenameGetWithHttpInfoAsync(target, varClient, rulename, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Alterian.JO.Client.ApiResponse<Object>> DownloadRuleTargetClientRulenameGetWithHttpInfoAsync(TargetEnum target, string varClient, string rulename, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'target' is set
            if (target == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/download/rule/{target}/{client}/{rulename}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
