...
> void DownloadRuleTargetClientRulenameGet (TargetEnum target, string varClient, string rulename)
...
namespace Example
{
    public class DownloadRuleTargetClientRulenameGetExample
    {
        public static void Main()
        {
            ...
            {
                // Download the rule file (KTR) for a running rule
                apiInstance.DownloadRuleTargetClientRulenameGet(target, varClient, rulename);
            }
...
{
    // Download the rule file (KTR) for a running rule
    apiInstance.DownloadRuleTargetClientRulenameGetWithHttpInfo(target, varClient, rulename);
}
catch (ApiException e)
{
...
|-------------|-------------|------------------|
| **200** | A uuencoded octet stream containing the KTR file |  -  |
