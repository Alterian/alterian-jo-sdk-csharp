...
> void DownloadTemplateClientTemplatenameGet (string varClient, string templatename)
...
namespace Example
{
    public class DownloadTemplateClientTemplatenameGetExample
    {
        public static void Main()
        {
            ...
            {
                // Download the rule file for a specific version of a specific template for a specific client
                apiInstance.DownloadTemplateClientTemplatenameGet(varClient, templatename);
            }
...
{
    // Download the rule file for a specific version of a specific template for a specific client
    apiInstance.DownloadTemplateClientTemplatenameGetWithHttpInfo(varClient, templatename);
}
catch (ApiException e)
{
...
> void DownloadTemplateClientTemplatenameVersionGet (string varClient, string templatename, int varVersion)
...
namespace Example
{
    public class DownloadTemplateClientTemplatenameVersionGetExample
    {
        public static void Main()
        {
            ...
            var varClient = "varClient_example";  // string | Client name
            var templatename = "templatename_example";  // string | The name of the template
            var varVersion = 56;  // int | The version of the file you want to download.

            try
            {
                // Download the rule file for a specific version of a specific template for a specific client
                apiInstance.DownloadTemplateClientTemplatenameVersionGet(varClient, templatename, varVersion);
            }
            catch (ApiException  e)
            {
...
{
    // Download the rule file for a specific version of a specific template for a specific client
    apiInstance.DownloadTemplateClientTemplatenameVersionGetWithHttpInfo(varClient, templatename, varVersion);
}
catch (ApiException e)
{
...
| **varClient** | **string** | Client name |  |
| **templatename** | **string** | The name of the template |  |
| **varVersion** | **int** | The version of the file you want to download. |  |
...
> TemplateUpgradeResponse TemplateClientTemplatenameVersionPost (string varClient, string templatename, int varVersion, Object? body = null)
...
namespace Example
{
    public class TemplateClientTemplatenameVersionPostExample
    {
        public static void Main()
        {
            ...
            {
                // Get an upgraded version of template
                TemplateUpgradeResponse result = apiInstance.TemplateClientTemplatenameVersionPost(varClient, templatename, varVersion, body);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Get an upgraded version of template
    ApiResponse<TemplateUpgradeResponse> response = apiInstance.TemplateClientTemplatenameVersionPostWithHttpInfo(varClient, templatename, varVersion, body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
