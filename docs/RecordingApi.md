...
> void RecordingClientTargetNameEventsGet (string varClient, TargetEnum target, string name, int? from = null, int? to = null)
...
namespace Example
{
    public class RecordingClientTargetNameEventsGetExample
    {
        public static void Main()
        {
            ...
            {
                // Get raw event traffic associated with this specific recording
                apiInstance.RecordingClientTargetNameEventsGet(varClient, target, name, from, to);
            }
            catch (ApiException  e)
            {
...
{
    // Get raw event traffic associated with this specific recording
    apiInstance.RecordingClientTargetNameEventsGetWithHttpInfo(varClient, target, name, from, to);
}
catch (ApiException e)
{
